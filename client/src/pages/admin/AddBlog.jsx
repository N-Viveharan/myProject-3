        ...
        <label htmlFor="image">
          ...
          onChange={(e)=>setSubTitle(e.target.value)} value={subTitle}/>
           ...
           <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
            <div ref={editorRef}></div>
             ...
             {loading&&(
              ...
              items-center justify-center bg-black/10 mt-2'> 
                  <div className='w-8 h-8 rounded-full border-2 border-t-white'></div>
             </div>)}
            ...
            bg-primary text-white rounded cursor-pointer text-sm'>{isAdding ? 'Adding':'Add Blog'}</button>

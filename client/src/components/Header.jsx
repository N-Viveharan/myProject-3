  ...
  return (
    <div className='mx-8 sm:mx-16  xl:mx:24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full 
            text-sm text-primary">
                <p>New:AI feature integrated</p>
                <img src={assets.star_icon} className='w-2.5' alt="" />
            </div>
            <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700 '>Your own Blogging <span className='text-primary'>blogging</span> <br /> Platform</h1>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
              This is your space to think out loud, to share what
                matters,  and to write without filters. Whether it's one word or a thousand,
                 ...
                 <form onSubmit={onSubmitHandler} className='flex items-center max-w-lg max-sm:scale-75 mx-auto border border-gray-300 
        bg-white rounded overflow-hidden'>
          ...
          transition-all cursor-pointer'>Search</button>
        </form>
